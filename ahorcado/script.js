...
const CATEGORIAS = {
  'Cantantes': ['shakira', 'karolG', 'bad bunny', 'feid', 'balvin', 'maluma', 'beele', 'edsheeran', 'taylorswift', 'brunoMars'],
  'Tecnología': ['celular', 'computador', 'portatil', 'internet', 'tablet', 'vpn', 'ciberseguridad', 'bigdata'],
  'Video Juegos':       ['farcry','damas','ludo','bingo','poker','domino','subway','rompecabezas','laberinto','naruto'],
  'Partes de el computador': ['monitor', 'teclado', 'raton', 'pantalla', 'procesador', 'memoria', 'discoduro', 'tarjetagrafica']
};
const MAX_ERRORES = 6;
...
function verificarEstado(){
  ...
  if(ok){
    ...
    msg.textContent='🎉 ¡Ganaste! +1 punto';
    GameAudio.win(); msg.className='gano';
    ...
    renderizarPalabra();
    msg.textContent='🤦‍♂️🤦‍♀️ Era: '+palabraSecreta.toUpperCase(); msg.className='perdio';
